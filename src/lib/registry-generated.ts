// AUTO-GENERATED — do not edit. Run: node scripts/build-registry.mjs
...
export const demos: DemoEntry[] = [
  {
    ...
    tags: ["scene"],
    rendererType: 'scene',
    scenePath: '/scenes/alien-garden.scene.yaml',
  ...
  },
  {
    name: 'billboard-hud',
    title: 'Billboard HUD',
    description: 'Sci-fi data visualization — 8 data nodes with always-facing Billboard labels, animated values, and connection lines',
    requiresWebGPU: false,
    color: '#44ffaa',
    tags: ["r3f-showcase"],
    rendererType: 'component',
    component: lazy(() => import('../demos/billboard-hud')),
  },
  {
    name: 'black-hole',
    title: 'Black Hole',
  ...
  },
  {
    name: 'camera-dolly',
    title: 'Camera Dolly',
    description: 'Cinematic auto-fly through a 20-arch corridor — sinusoidal camera path, speed lines, and glowing portal',
    requiresWebGPU: false,
    color: '#ff8844',
    tags: ["r3f-showcase"],
    rendererType: 'component',
    component: lazy(() => import('../demos/camera-dolly')),
  },
  {
    name: 'cave-system',
    title: 'Cave System',
  ...
  },
  {
    ...
    description: 'Grid of 16 mystery cubes that unfold on click to reveal glowing inner objects — sphere, torus, crystal and more — with smooth animation',
    requiresWebGPU: false,
    color: '#6644ff',
    tags: ["interactive"],
    rendererType: 'component',
    component: lazy(() => import('../demos/click-to-reveal')),
  },
  {
    name: 'cloth-wind',
    title: 'Cloth in Wind',
  ...
  {
    name: 'contact-shadows-demo',
    title: 'Contact Shadows',
    description: '7 floating objects with dynamic contact shadow simulation — shadows soften and shrink as objects float higher',
    requiresWebGPU: false,
    color: '#44cc88',
    tags: ["r3f-showcase"],
    rendererType: 'component',
    component: lazy(() => import('../demos/contact-shadows-demo')),
  },
  {
    name: 'coral-reef',
    title: 'Coral Reef',
  ...
  },
  {
    ...
    tags: ["scene"],
    rendererType: 'scene',
    scenePath: '/scenes/cyberpunk-street.scene.yaml',
  ...
  },
  {
    ...
    tags: ["scene"],
    rendererType: 'scene',
    scenePath: '/scenes/desert-outpost.scene.yaml',
  ...
  },
  {
    name: 'drag-physics',
    title: 'Drag Physics',
    description: 'Click and drag 12 instanced spheres with spring physics — stretch toward pointer, spring back on release with trail particles',
    requiresWebGPU: false,
    color: '#ff4466',
    tags: ["interactive"],
    rendererType: 'component',
    component: lazy(() => import('../demos/drag-physics')),
  },
  {
  ...
  },
  {
    ...
    tags: ["scene"],
    rendererType: 'scene',
    scenePath: '/scenes/enchanted-forest.scene.yaml',
    component: lazy(() => import('../demos/enchanted-forest')),
  },
  {
    name: 'environment-hdr',
    title: 'Environment HDR',
    description: '5 chrome spheres demonstrating roughness 0.0 to 1.0 against a simulated city HDR environment',
    requiresWebGPU: false,
    color: '#ccaa44',
    tags: ["r3f-showcase"],
    rendererType: 'component',
    component: lazy(() => import('../demos/environment-hdr')),
  },
  {
    name: 'equalizer-city',
  ...
  },
  {
    name: 'explode-mesh',
    title: 'Explode Mesh',
    description: 'Click a dodecahedron to explode it into face fragments flying outward with gravity — debris settles then reassembles in a satisfying loop',
    requiresWebGPU: false,
    color: '#ccff44',
    tags: ["interactive"],
    rendererType: 'component',
    component: lazy(() => import('../demos/explode-mesh')),
  },
  {
  ...
  },
  {
    name: 'float-island',
    title: 'Float Island',
    description: 'Dreamy floating terrain scene using drei Float — displaced icosahedron island with trees, waterfall, and clouds',
    requiresWebGPU: false,
    color: '#22ccaa',
    tags: ["r3f-showcase"],
    rendererType: 'component',
    component: lazy(() => import('../demos/float-island')),
  },
  {
  ...
  },
  {
    name: 'fps-explorer',
    title: 'FPS Explorer',
    description: 'First-person camera through a glowing corridor with WASD movement, pointer lock mouse look, floating crystals and archway openings',
    requiresWebGPU: false,
    color: '#44ff66',
    tags: ["interactive"],
    rendererType: 'component',
    component: lazy(() => import('../demos/fps-explorer')),
  },
  {
    name: 'fractal-zoom',
    title: 'Fractal Zoom',
  ...
  },
  {
    name: 'gesture-orbit',
    title: 'Gesture Orbit',
    description: 'Orbit a torus knot with momentum — spin and release for decay, double-tap to snap to preset camera angles with smooth animated transitions',
    requiresWebGPU: false,
    color: '#44ccff',
    tags: ["interactive"],
    rendererType: 'component',
    component: lazy(() => import('../demos/gesture-orbit')),
  },
  {
    ...
    tags: ["scene"],
    rendererType: 'scene',
    scenePath: '/scenes/gladiator-arena.scene.yaml',
  ...
  },
  {
    name: 'hover-morph',
    title: 'Hover Morph',
    description: 'A sphere that morphs based on pointer proximity — vertices near the intersection bulge outward via TSL positionNode displacement with color shift',
    requiresWebGPU: false,
    color: '#ff8822',
    tags: ["interactive"],
    rendererType: 'component',
    component: lazy(() => import('../demos/hover-morph')),
  },
  {
  ...
  },
  {
    ...
    tags: ["scene"],
    rendererType: 'scene',
    scenePath: '/scenes/junkyard.scene.yaml',
  ...
  },
  {
    ...
    description: 'Animated 3D text using drei Text component — 6 words each with unique motion personality and color cycling',
    requiresWebGPU: false,
    color: '#ff44aa',
    tags: ["r3f-showcase"],
    rendererType: 'component',
    component: lazy(() => import('../demos/kinetic-typography')),
  },
  {
    name: 'klein-bottle',
    title: 'Klein Bottle',
  ...
  },
  {
    ...
    tags: ["scene"],
    rendererType: 'scene',
    scenePath: '/scenes/medieval-forge.scene.yaml',
  ...
  },
  {
    ...
    description: 'Reflective corridor with 7 glowing geometric sculptures and Y-flipped mirror floor simulation',
    requiresWebGPU: false,
    color: '#8844ff',
    tags: ["r3f-showcase"],
    rendererType: 'component',
    component: lazy(() => import('../demos/mirror-gallery')),
  },
  {
    name: 'moebius-flow',
    title: 'Moebius Flow',
  ...
  },
  {
    name: 'paint-canvas',
    title: 'Paint Canvas',
    description: 'Draw on a 3D surface — drag to spawn glowing paint dots with rainbow color cycling, speed-based brush size, and a clear button',
    requiresWebGPU: false,
    color: '#ff44cc',
    tags: ["interactive"],
    rendererType: 'component',
    component: lazy(() => import('../demos/paint-canvas')),
  },
  {
    name: 'particle-attractor',
    title: 'Particle Attractor',
    description: '5000 particles swirl toward the mouse pointer with spring attraction and orbital vortex — color by velocity, release to scatter',
    requiresWebGPU: false,
    color: '#ff6688',
    tags: ["interactive"],
    rendererType: 'component',
    component: lazy(() => import('../demos/particle-attractor')),
  },
  {
    name: 'particle-field',
  ...
  },
  {
    ...
    description: 'PresentationControls product showcase with metallic torus knot, orbital particle ring, and reflective platform',
    requiresWebGPU: false,
    color: '#44aaff',
    tags: ["r3f-showcase"],
    rendererType: 'component',
    component: lazy(() => import('../demos/product-turntable')),
  },
  {
    name: 'pulse-grid',
    title: 'Pulse Grid',
  ...
  {
    name: 'ripple-interact',
    title: 'Ripple Interact',
    description: 'Click a water plane to spawn expanding ripple waves — TSL displacement with up to 10 simultaneous ripples creating interference patterns',
    requiresWebGPU: false,
    color: '#88ff44',
    tags: ["interactive"],
    rendererType: 'component',
    component: lazy(() => import('../demos/ripple-interact')),
  },
  {
    name: 'robot-factory',
    title: 'Robot Factory',
    ...
    tags: ["scene"],
    rendererType: 'scene',
    scenePath: '/scenes/robot-factory.scene.yaml',
  ...
  },
  {
    ...
    description: 'Time-driven camera journey through 5 narrative sections, each with unique geometry and TSL glow materials',
    requiresWebGPU: false,
    color: '#ff6644',
    tags: ["r3f-showcase"],
    rendererType: 'component',
    component: lazy(() => import('../demos/scroll-storytelling')),
  },
  {
    name: 'sdf-morphscape',
  ...
  },
  {
    ...
    tags: ["scene"],
    rendererType: 'scene',
    scenePath: '/scenes/space-station.scene.yaml',
    component: lazy(() => import('../demos/space-station')),
  },
  {
    name: 'sparkle-field',
    title: 'Sparkle Field',
    description: 'Pure atmospheric scene — drei Sparkles and Stars with volumetric clouds, orbiting motes, and golden glow',
    requiresWebGPU: false,
    color: '#ffcc22',
    tags: ["r3f-showcase"],
    rendererType: 'component',
    component: lazy(() => import('../demos/sparkle-field')),
  },
  {
    name: 'spiral-galaxy',
    title: 'Spiral Galaxy',
  ...
  },
  {
    ...
    tags: ["scene"],
    rendererType: 'scene',
    scenePath: '/scenes/test-scene.scene.yaml',
  ...
  },
  {
    ...
    tags: ["scene"],
    rendererType: 'scene',
    scenePath: '/scenes/underwater-ruins.scene.yaml',
  ...
  },
  {
    name: 'zoom-universe',
    title: 'Zoom Universe',
    description: 'Scroll to zoom from galaxy scale to atom scale through 5 levels: galaxy stars, solar system, earth, city, electron cloud',
    requiresWebGPU: false,
    color: '#2244ff',
    tags: ["interactive"],
    rendererType: 'component',
    component: lazy(() => import('../demos/zoom-universe')),
  },
];
